...
#define CONF_USB_H_VBUS_CTRL_FUNC_NAME "vbus_ctrl_func"
#endif

extern void vbus_ctrl_func(void *drv, uint8_t port, bool onoff);
#ifndef CONF_USB_H_VBUS_CTRL_FUNC
#define CONF_USB_H_VBUS_CTRL_FUNC vbus_ctrl_func
#endif
// </e>
